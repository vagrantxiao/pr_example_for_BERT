set logFileId [open ./runLogImpl_mul.log "w"]
...
read_checkpoint -cell floorplan_static_i/leaf_empty_5/inst page_mul_netlist.dcp
...
set start_time [clock seconds]
write_bitstream  -force  -cell floorplan_static_i/leaf_empty_5/inst mul.bit
set end_time [clock seconds]
set total_seconds [expr $end_time - $start_time]
puts $logFileId "bit_gen: $total_seconds seconds"
report_utilization -pblocks p_5 > impl_utilization_mul.rpt
report_timing_summary > timing_mul.rpt
